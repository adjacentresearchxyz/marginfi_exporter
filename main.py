...
class PrometheusClient:
    def __init__(self):
        ...
        self.marginfi_margin_requirement_initial = Gauge("marginfi_margin_requirement_initial", 'Marginfi Account Margin Initial Requirement', ['marginfi_address'])
        self.marginfi_margin_requirement_maintenance = Gauge("marginfi_margin_requirement_maintenance", 'Marginfi Account Margin Maintenance Requirement', ['marginfi_address'])
        self.marginfi_margin_requirement_partial_liquidation = Gauge("marginfi_margin_requirement_partial_liquidation", 'Marginfi Account Margin Partial Liquidation Requirement', ['marginfi_address'])
    ...
    async def marginfi(self):
        ...
        for account in all_accounts:
            ...
            self.marginfi_margin_requirement_initial.labels(marginfi_address=authority).set(margin_requirement_initial)
            self.marginfi_margin_requirement_maintenance.labels(marginfi_address=authority).set(margin_requirement_maintenance)
            self.marginfi_margin_requirement_partial_liquidation.labels(marginfi_address=authority).set(margin_requirement_partial_liquidation)
